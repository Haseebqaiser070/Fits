...
import 'package:fits_daxno/view/ViewAll.dart';
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image:
                                    AssetImage('assets/images/homeslider.png'),
                                fit: BoxFit.fill)),
                      ),
                      SizedBox(
                        height: 30,
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          InkWell( onTap: (){
                            Navigator.of(context).push(MaterialPageRoute(builder: (context)=>contactUsView()));
                          },child: Text('Contact Us',style: GoogleFonts.workSans(color: Colors.white,fontSize: 12),)),
                        ],
                      ),
                    ),
                    Container(
                      height: 70,
                      width: 100,
                      decoration: BoxDecoration(image: DecorationImage(fit:BoxFit.fill,image: AssetImage('assets/images/logo.png'))),),
                    Row(
                      children: [
