...
class sendMessageWidget extends StatefulWidget {
  sendMessageWidget({Key ,key,this.message_model}) : super(key: key);
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style:GoogleFonts.domine(textStyle: TextStyle(color: Colors.white, fontSize: 14)),
                            ),
                            SizedBox(height: 10,),
                            Row(mainAxisAlignment: MainAxisAlignment.end,
                              children: [
                                Text(
                                  ...
                                  style:GoogleFonts.domine(textStyle: TextStyle(color: Colors.white, fontSize: 10)),
                                )
                              ],
                            )
                          ],
